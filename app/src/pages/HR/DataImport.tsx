...
import { Download, Upload, Loader2, FileSpreadsheet, CheckCircle2, XCircle, Users } from 'lucide-react';
...
export function DataImport() {
  return (
    <div className="p-6 space-y-6">
      ...
      <Tabs defaultValue="hr-archive" className="space-y-4">
        <TabsList>
          <TabsTrigger value="hr-archive">人事档案上传</TabsTrigger>
          <TabsTrigger value="employee-template">员工模板导入</TabsTrigger>
        </TabsList>

        <TabsContent value="hr-archive">
          <HrArchiveImport />
        </TabsContent>

...
| 前端开发部 | FRONTEND | engineering | 前端技术开发 |
| 后端开发部 | BACKEND | engineering | 后端服务开发 |
| 架构部 | ARCH | engineering | 系统架构设计 |
| 运维开发部 | DEVOPS | engineering | CI/CD 和基础设施 |
| 安全部 | SECURITY | engineering | 安全策略和漏洞管理 |
...
| 前端开发主管 | 前端开发部 | senior | 前端技术架构和团队管理 |
| 高级前端工程师 | 前端开发部 | senior | 前端核心模块开发 |
| 中级前端工程师 | 前端开发部 | intermediate | 前端功能开发 |
| 初级前端工程师 | 前端开发部 | junior | 前端基础开发 |
| 后端开发主管 | 后端开发部 | senior | 后端架构和团队管理 |
| 高级后端工程师 | 后端开发部 | senior | 后端核心服务开发 |
| 中级后端工程师 | 后端开发部 | intermediate | 后端功能开发 |
| 初级后端工程师 | 后端开发部 | junior | 后端基础开发 |
| 架构师 | 架构部 | senior | 系统架构设计和技术选型 |
| 高级架构师 | 架构部 | senior | 复杂系统架构设计 |
| 运维开发主管 | 运维开发部 | senior | CI/CD 和基础设施管理 |
| 高级运维工程师 | 运维开发部 | senior | 自动化运维和监控 |
| 安全主管 | 安全部 | senior | 安全策略和漏洞管理 |
| 安全工程师 | 安全部 | intermediate | 安全测试和审计 |
...
| 模板 | 适用岗位 | 级别 | 核心指标 |
|------|---------|------|---------|
| 工程技术中心 - 高级工程师考核模板 | 高级工程师 | senior | 任务完成、代码质量、Bug 修复、技术创新 |
| 工程技术中心 - 中级工程师考核模板 | 中级工程师 | intermediate | 任务完成、代码质量、Bug 修复、文档 |
| 工程技术中心 - 初级工程师考核模板 | 初级工程师 | junior | 任务完成、工作质量、学习能力、主动性 |
| 前端开发部 - 前端开发主管考核模板 | 前端开发主管 | senior | 任务完成、代码质量、项目交付、领导力 |
| 前端开发部 - 高级前端工程师考核模板 | 高级前端工程师 | senior | 任务完成、代码质量、Bug 修复、技术创新 |
| 前端开发部 - 中级前端工程师考核模板 | 中级前端工程师 | intermediate | 任务完成、代码质量、Bug 修复、文档 |
| 后端开发部 - 后端开发主管考核模板 | 后端开发主管 | senior | 任务完成、代码质量、项目交付、领导力 |
| 后端开发部 - 高级后端工程师考核模板 | 高级后端工程师 | senior | 任务完成、代码质量、Bug 修复、技术创新 |
| 后端开发部 - 中级后端工程师考核模板 | 中级后端工程师 | intermediate | 任务完成、代码质量、Bug 修复、文档 |
| 架构部 - 架构师考核模板 | 架构师 | senior | 任务完成、技术创新、问题解决、文档 |
| 架构部 - 高级架构师考核模板 | 高级架构师 | senior | 任务完成、技术创新、问题解决、领导力 |
| 运维开发部 - 运维开发主管考核模板 | 运维开发主管 | senior | 任务完成、工作效率、领导力、技术创新 |
| 运维开发部 - 高级运维工程师考核模板 | 高级运维工程师 | senior | 任务完成、工作效率、技术创新、问题解决 |
| 安全部 - 安全主管考核模板 | 安全主管 | senior | 任务完成、问题解决、领导力、文档 |
| 安全部 - 安全工程师考核模板 | 安全工程师 | intermediate | 任务完成、问题解决、文档、专业技能 |
| 测试部 - 高级测试工程师考核模板 | 高级测试工程师 | senior | 任务完成、工作质量、Bug 修复、技术创新 |
| 测试部 - 中级测试工程师考核模板 | 中级测试工程师 | intermediate | 任务完成、工作质量、效率、文档 |
| 销售部 - 销售经理考核模板 | 销售经理 | senior | 销售完成、回款率、团队绩效、客户满意度 |
| 销售部 - 销售代表考核模板 | 销售代表 | intermediate | 销售完成、新客户开发、回款率、客户满意度 |
| 生产部 - 生产经理考核模板 | 生产经理 | senior | 产量完成、工作质量、安全、设备利用 |
| 生产部 - 生产工人考核模板 | 生产工人 | junior | 产量完成、工作质量、安全、出勤 |
| 人力资源部 - HR 经理考核模板 | HR 经理 | senior | 任务完成、团队绩效、战略执行、领导力 |
| 质量部 - 质量经理考核模板 | 质量经理 | senior | 工作质量、任务完成、问题解决、文档 |
| 财务部 - 财务经理考核模板 | 财务经理 | senior | 任务完成、成本控制、工作质量、文档 |

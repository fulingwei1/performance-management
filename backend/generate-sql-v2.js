...
// Generate SQL using correct table names
const sqlLines = [];
...
for (const t of templates) {
  ...
  sqlLines.push(`INSERT INTO assessment_templates (id, name, description, department_type, is_default, status, priority) VALUES ('${t.id}', '${t.name.replace(/'/g, "''")}', '${t.description.replace(/'/g, "''")}', '${t.department_type}', ${isDefault}, '${t.status}', ${t.priority});`);
}

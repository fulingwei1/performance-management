...
async function syncTemplatesToDatabase() {
  ...
  const legacyTemplateIds = [
    ...
    'template-eng-junior-001',
    'template-eng-inter-001',
    'template-eng-senior-001',
    'template-eng-mgr-001',
    'template-mfg-default',
    'template-mfg-junior-001',
    'template-mfg-senior-001',
    'template-mfg-mgr-001',
    'template-sup-default',
    'template-sup-junior-001',
    'template-sup-senior-001',
    'template-sup-mgr-001',
    'template-mgmt-gm-001',

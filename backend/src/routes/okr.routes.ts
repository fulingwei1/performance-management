...
router.get('/strategic-objectives', asyncHandler(async (_req, res) => {
...
router.post('/strategic-objectives', asyncHandler(async (req, res) => {
...
router.put('/strategic-objectives/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.delete('/strategic-objectives/:id', asyncHandler(async (req, res) => {
...
router.get('/objectives/my', asyncHandler(async (req, res) => {
  const results = await query(
...
router.get('/objectives/tree', asyncHandler(async (_req, res) => {
  const results = await query(
...
router.get('/objectives/:id/feedbacks', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/objectives/related', asyncHandler(async (req, res) => {
  const results = await query(
    `SELECT o.*, emp.name as owner_name 
     FROM objectives o 
     LEFT JOIN employees emp ON o.owner_id = emp.id
...
// ===== Key Results =====
router.get('/objectives/:objectiveId/krs', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.post('/objectives/:objectiveId/krs', asyncHandler(async (req, res) => {
  res.json({ success: true, data: { id: `kr-${Date.now()}` }, message: 'KR已创建' });
}));

router.put('/krs/:id', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已更新' });
}));

router.delete('/krs/:id', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已删除' });
}));

// ===== KPIs =====
router.get('/kpis/my', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/kpis/employee/:employeeId', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/kpis/department/:department', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));
...
router.put('/kpis/:id/actual', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已更新' });
}));
...
// ===== Contracts =====
router.get('/contracts/my', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));
...
router.post('/contracts/:id/approve', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已审批' });
}));

// ===== Monthly Reports =====
router.get('/monthly-reports/my', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/monthly-reports/employee/:employeeId', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/monthly-reports/team', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.post('/monthly-reports', asyncHandler(async (req, res) => {
  res.json({ success: true, data: { id: `report-${Date.now()}` }, message: '已提交' });
}));

router.post('/monthly-reports/:id/review', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已评审' });
}));

// ===== Assignments =====
router.post('/objectives/:objectiveId/assign', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已分配' });
}));

router.get('/assignments/my', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.put('/assignments/:id/complete', asyncHandler(async (req, res) => {
  res.json({ success: true, message: '已完成' });
}));

// ===== Interviews =====
router.get('/interviews/my', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));

router.get('/interviews/team', asyncHandler(async (req, res) => {
  res.json({ success: true, data: [] });
}));
